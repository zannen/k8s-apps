...
dbPassword="$(pwgen -s 30 1)"
dbPassword_b64="$(echo -n "$dbPassword" | base64)"
tokenSigningKey="$(pwgen -s 30 1)"
tokenSigningKey_b64="$(echo -n "$tokenSigningKey" | base64)"
...
dbPassword: $dbPassword_b64  # $dbPassword

tokenSigningPassword: $tokenSigningKey_b64  # $tokenSigningKey
EOF
